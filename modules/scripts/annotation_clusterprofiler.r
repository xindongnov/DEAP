...
if (species == 'mm'){
gene_entriz <- bitr(gene_list, fromType="SYMBOL", toType=c("ENTREZID"), OrgDb="org.Mm.eg.db")
...
ggsave(figure_path, p, width = 5, height = 5, scale=1.5) + scale_y_discrete(labels = function(x) str_wrap(x, width=30))
